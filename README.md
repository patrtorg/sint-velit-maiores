...
[![CI](https://github.com/patrtorg/sint-velit-maiores/workflows/CI/badge.svg)](https://github.com/patrtorg/sint-velit-maiores/actions/workflows/ci.yml)
[![NPM version](https://img.shields.io/npm/v/@patrtorg/sint-velit-maiores.svg?style=flat)](https://www.npmjs.com/package/@patrtorg/sint-velit-maiores)
...
resources that demonstrate the use of @patrtorg/sint-velit-maiores in different use-cases and scenarios:

* A reference application using [Fastify with @patrtorg/sint-velit-maiores and dotenv](https://github.com/lirantal/fastify-dotenv-envschema-example)
